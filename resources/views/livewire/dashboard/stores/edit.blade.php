<div>
    ...
    <div class="border-b mb-10 flex py-4 justify-between gap-4 items-center">
        ...
        <div>
            <x-secondary-button href="{{route('dashboard.stores.index')}}">
                Ir a listado de negocios
            </x-secondary-button>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1">
                                ...
                                <select class="w-full" wire:model="store.status">
                                    ...
                                    <option value="3">Requiere cambios</option>
                                    <option value="4">Rechazado</option>
                                    <option value="5">Cambios pendientes de revisar</option>
                                </select>
